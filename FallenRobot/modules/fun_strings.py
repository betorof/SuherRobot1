RUN_STRINGS = (
    "Sekarang kamu melihatku, sekarang tidak." "ε=ε=ε=ε=┌(;￣▽￣)┘",
    "Kembali kesini!",
    "REEEEEEEEEEEEEEEEEEEE!!!!!!!!",
    "Awas temboknya!",
    "Jangan tinggalkan aku sendirian bersama mereka!!",
    "Kamu punya teman!",
    "Chotto matte!",
    "Yare yare linglung",
    "*Naruto dijalankan diaktifkan*",
    "*Nezuko dijalankan diaktifkan*",
    "Hei, bertanggung jawablah atas apa yang baru saja kamu lakukan!",
    "Semoga peluangnya menguntungkanmu.",
    "Lari semuanya, mereka baru saja menjatuhkan bom 💣💣",
    "Dan mereka menghilang selamanya, tidak pernah terlihat lagi.",
    "Legendanya, mereka masih berjalan.",
